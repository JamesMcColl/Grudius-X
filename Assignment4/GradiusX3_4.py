""" Name: James McColl
    ...
    - Moved all working parts of game into one file
    
    
    Guide the ship past enemies and collect power-ups to increase your score
    """
...
def game():
    screen = pygame.display.set_mode((640, 480))
    pygame.display.set_caption("Gradius X & 3/4")
...
#Was unable to find a way to get the game over screen to work properly, but here is what I have
"""def gameOver(score):
    ship = Ship()
    space = Space()
    ...
    for line in gameOver:
        tempLabel = insFont.render(line, 1, (200, 150, 255))
        insLabels.append(tempLabel)
